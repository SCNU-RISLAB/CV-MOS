...
if __name__ == '__main__':
    ...
    # load config file
    dataset = "/data/2022/zeyu/kitti_dataset"
    ...
    all_seq_list = [i for i in range(0, 22)] + [i for i in range(30, 42)]   # 0-10 for training
    if config['residual_aug']:
        residual_list = [1 * i for i in range(1, 9)] + [9, 10, 11, 13, 15, 16, 19, 22]
    else:
